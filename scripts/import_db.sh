...
if ! command -v mysql >/dev/null 2>&1; then
  echo "No se ha encontrado el cliente mysql en el PATH."
  exit 1
fi
...
echo "La migracion sql/migracion_autenticacion_es.sql solo se utiliza al actualizar instalaciones antiguas."
